...
| # | Pendência | Detalhe |
|---|---|---|
| 3.1 | **Repositório no GitHub** | ✅ Feito em 23/08/2026: `taoklyn/taoklyn-site`, privado. A `main` anterior era o VITORDIS e foi **substituída** por decisão do cliente — o código do VITORDIS continua no computador dele. |
